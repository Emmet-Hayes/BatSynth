...
void CustomFeel::drawRotarySlider(Graphics& g, int x, int y, int width, int height, float sliderPos, 
...
void CustomFeel::drawComboBox(Graphics& g, int w, int h, bool isDown, int bx, int by, int bw, int bh, ComboBox& cb) 
{
	Colour c(30, 8, 33);
	g.setColour(c);
	g.fillAll();
